...
const SampleComponent = () => {
  ...
  return (
    <>
      ...
      <div className="overflow-hidden rounded-lg border boorder-gray-200 bg-white">
        <div className="max-w-full max-h-[calc(100vh-)] overflow-x-auto">
          <Table>
            <TableHeader className="border-border-gray-100 bg-blue-600 text-white sticky top-0 z-30 text-xs">
              <TableRow>
                <TableCell
                  isHeader
