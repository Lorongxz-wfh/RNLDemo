  ...
  const handleUpdateUser = async (e: FormEvent) => {
    try {
      ...
      if (res.status === 200) {
        ...
        console.error(
          "Unexpected status error occurred during user update: ",
          res.status
        );
      }
    } catch (error: any) {
      if (error.response && error.response.status === 422) {
        ...
        console.error(
          "Unexpected server error occurred during user update: ",
          error
        );
      }
    } finally {
  ...
  const handleLoadGenders = async () => {
    try {
      ...
      if (res.status === 200) {
        ...
        console.error(
          "Unexpected status error occurrred during loading genders: ",
          res.status
        );
      }
    } catch (error) {
